...
// ── 1. Serve General Assets (CSS, JS at the root) ───────────────────────────
app.use(express.static(frontendPath));

// ── 2. Serve the Pages folder directly ──────────────────────────────────────
// This allows both /src/pages/inventory.html AND /pages/inventory.html
app.use('/src/pages', express.static(pagesPath));
